    ...
    <div class="row four bouns-list" style="margin:0; margin-top:50px;">
        <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
            <div style="width:99%;"  class="money-1 bouns-1">
                ...
                <h2 style="font-weight: bold;"><span>{{ $data['firstGenerationBonus'] }}</span>元</h2>
        ...
        <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
            ...
            <div style="width:99%;" class="money-1 bouns-1">
                ...
                <h2 style="font-weight: bold;"><span>{{ $data['firstGenerationPeople'] }}</span>人</h2>
        ...
        <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
            <div style="width:99%;"  class="money-1 bouns-1">
                ...
                <h2 style="font-weight: bold;"><span>{{ $data['secondGenerationBonus'] }}</span>元</h2>
            ...
            <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
                ...
                <div style="width:99%;" class="money-1 bouns-1">
                    ...
                    <h2 style="font-weight: bold;"><span>{{ $data['secondGenerationPeole'] }}</span>人</h2>
            ...
            <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
                <div style="width:99%;"  class="money-1 bouns-1">
                    ...
                    <h2 style="font-weight: bold;"><span>{{ $data['credit'] }}</span>元</h2>
        ...
        <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
            ...
            <div style="width:99%;" class="money-1 bouns-1">
                ...
                <h2 style="font-weight: bold;"><span>{{ $data['managerBonus'] }}</span>元</h2>
        ...
        <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
            <div style="width:99%;"  class="money-1 bouns-1">
                ...
                <h2 style="font-weight: bold;"><span>{{ $data['personalNet'] }}</span>元</h2>
            ...
            <div class="col-md-6 col-xs-6 col-sm-6 money" style="padding:0;">
                ...
                <div style="width:99%;" class="money-1 bouns-1">
                    ...
                    <h2 style="font-weight: bold;"><span>{{ $data['teamNet'] }}</span>元</h2>
