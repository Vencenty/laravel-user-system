...
@section('content')
    ...
    <div class="row nav-top" style="margin:0;">
        ...
        <div class="nav-r col-md-1 col-sm-2 col-xs-2" id="avatar" style="padding:0;">
            <img  src="{{ auth()->user()->avatar ?? '/static/image/default-pic.png' }}"
        ...
        <a href="/home/staticBonus">
            <div class="col-md-6  col-xs-6 col-sm-6 title-2"  style="padding:0;">
                <div style="width:100%;" class="bg-2 total-top">
                    <h2>总收益(静态)</h2>
                    <h1><span>{{ $data['static_total'] }}</span>元</h1>
                </div>
            </div>
        </a>
        ...
        <a href="/home/yesterdayShare">
            <div class=" col-md-6 col-xs-6 col-sm-6" style="padding:0;">
                <div style="width:99%;" class="bg-5 total-top">
                    <h2>前日分红</h2>
                    <h1><span>{{ $data['yesterday_share'] }}</span>元</h1>
                </div>
                <div style="width:2%;"></div>
            </div>
        </a>
        ...
        <a href="/home/yesterdayBonus">
            <div class=" col-md-6 col-xs-6 col-sm-6" style="padding:0;">
                <div style="width:100%;" class="bg-6 total-top">
                    <h2>前日奖金</h2>
                    <h1><span>{{ $data['yesterday_bonus'] }}</span>元</h1>
                </div>
            </div>
        </a>
    </div>

    {{--<div class="row jihuo-door" style="margin:0;">--}}
        {{--<div class="col-md-12 col-sm-12 col-xs-12 jihuo-til">--}}
            {{--<p class="jihuo-name">购物升级专区</p>--}}
            {{--<p class="jihuo-num">多种选择</p>--}}
        {{--</div>--}}
        {{--<div class=" col-md-12 col-sm-12 col-xs-12" style="padding:0;">--}}
            {{--<a href="http://pt.hrkj1319.com/app/index.php?i=4&c=entry&m=ewei_shopv2&do=mobile&r=diypage&id=51"><img src="/static/image/jihuo-bg.png" alt="" width="100%"></a>--}}
        {{--</div>--}}
    {{--</div>--}}
