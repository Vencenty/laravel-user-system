...
<?php $__env->startSection('content'); ?>
    <div class="row one-member" style="box-shadow: none;margin-top: 70px;">
        <ul>
            ...
            <?php else: ?>
                <li class="col-md-12 under-line" style="padding:0; text-align: center;font-size: 1.2em;height: 100px;line-height: 100px;color:#ccc;">您目前暂无二代推荐人</li>
            <?php endif; ?>
        </ul>
    </div>
<?php $__env->stopSection(); ?>
